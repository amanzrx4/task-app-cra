...
const Modal = ({ show, onAbort, onConfirm, text }) => {
  return (
    <>
      {show ? (
        <div id="popup-modal" className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal h-full w-full bg-black bg-opacity-30" onClick={onAbort}>
          <div className="relative p-4 w-full h-full md flex justify-center items-center" onClick={onAbort}>
